...
(function() {
    ...
    async function loadMoreProducts() {
        ...
        try {
            ...
            console.log("--- DADOS BRUTOS DA API (DIAGNÓSTICO) ---");
            console.log("Por favor, copie o conteúdo abaixo e cole no chat.");
            // Mostra os 5 primeiros produtos que chegam da API
            console.log(JSON.stringify(newProductsData.data.slice(0, 5), null, 2)); 
            const activeIdsRaw = localStorage.getItem('resellerActiveProductIds');
            console.log("IDs Ativos Salvos no localStorage:", activeIdsRaw);
            console.log("-----------------------------------------");
            // --- FIM DO DIAGNÓSTICO ---
